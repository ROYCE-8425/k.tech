    ...
    <div class="max-w-2xl mx-auto py-4">
        ...
        <div class="text-center mb-8 animate-slide-up">
            ...
            <p class="text-gray-500 text-sm max-w-md mx-auto">
                <?php echo e(__('AI tự động phân tích CV ứng viên, so khớp với Job Description, và xếp hạng cho nhà tuyển dụng.')); ?>
            ...
            <form action="<?php echo e(route('demo.enter-candidate')); ?>" method="POST">
                ...
                <button type="submit" id="btn-enter-candidate"
                    ...
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            <h2 class="text-lg font-bold text-gray-900"><?php echo e(__('Vào vai Ứng viên')); ?></h2>
                            <p class="text-xs text-gray-500"><?php echo e(__('Xem job → Ứng tuyển → AI phân tích CV')); ?></p>
                        </div>
                    </div>
            ...
            <form action="<?php echo e(route('demo.enter-recruiter')); ?>" method="POST">
                ...
                <button type="submit" id="btn-enter-recruiter"
                    ...
                    <div class="flex items-center gap-3 mb-3">
                        ...
                        <div>
                            <h2 class="text-lg font-bold text-gray-900"><?php echo e(__('Vào vai Nhà tuyển dụng')); ?></h2>
                            <p class="text-xs text-gray-500"><?php echo e(__('Xem AI Shortlist → Đánh giá ứng viên')); ?></p>
                        </div>
                    </div>
                    <div class="bg-gray-50 rounded-xl p-3 text-xs text-gray-500 space-y-1 mb-3">
                        <p class="font-semibold text-gray-700">Tài khoản demo:</p>
