                    ...
                    <div class="hidden md:flex items-center gap-1">
                        ...
                        @auth
                            ...
                            @else
                                ...
                                <a href="{{ route('candidate.profile') }}" class="px-4 py-2 rounded-lg font-medium transition-colors {{ request()->is('candidate/profile') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50' }}">
                                    <div class="flex items-center gap-2">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="space-y-1">
                    ...
                    @auth
                        ...
                        @else
                            ...
                            <a href="{{ route('candidate.profile') }}" class="block px-4 py-3 rounded-lg font-medium {{ request()->is('candidate/profile') ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-50' }}">
                                Hồ sơ
                            </a>
                        @endif
